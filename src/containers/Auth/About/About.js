        ...
        <Card className={cx(cardStyles.root, shadowStyles.root)}>
          ...
          <CardContent className={cardStyles.content}>
            <TextInfoContent
              ...
              heading={"About"}
              body={
                "This is an Learning Spot Web App was bootstrapped with Create React App and other libraries. The UI build base on Material-UI along with the associated library ecosystem."
              }
            />
            <TextInfoContent
              classes={styles}
